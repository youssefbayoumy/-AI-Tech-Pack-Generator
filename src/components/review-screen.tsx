...
function readableValue(value: unknown, precision?: 'approximate'): string {
  if (value === null) return 'Not specified';
  if (typeof value === 'object') return 'Structured value';
  const displayed = String(value);
  return precision === 'approximate' && typeof value === 'number' ? `~${displayed}` : displayed;
}
