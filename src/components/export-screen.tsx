...
export function ExportScreen() {
  ...
  return <main className="export-page"><header className="export-toolbar"><Link className="brand" href="/workspace"><span className="brand-mark">M</span><span>MASDR</span></Link><div><p className="eyebrow">DOCUMENT PREVIEW</p><strong>Same canonical draft · no PDF generated</strong></div><Link className="button button--secondary" href="/workspace">Back to workspace</Link></header>
